...
\end{comment}
	...
	\cvevent{\en{Volvo Car}\sv{Göteborg Representant}}{| \en{Software Developer}\sv{Wanda Sweden}}
		...
		single handedly wrote and developed a Python application for inhouse use as a database and data visualizer, to help improve the teams CFD workflow. The application was developed using mainly python libraries: SQLite and 				QTWidgets. During my time here I learned a lot about fullstack development and troubleshooting/optimization since the GUI was slow at displaying large amounts of data if done incorrectly. \\
            }
            \sv{}
	...
	\cvevent{\en{Wanda Sweden}\sv{Göteborg Representant}}{| \en{Gothenburg Representative}\sv{Wanda Sweden}}
		...
		Since August of 2023 I also had the responsibility of route planning/capacity management for all of the warehouses in Sweden. At Wanda I developed a lot of experience in having big responsibilities and being in charge of 			overseeing work. \\
            }
            \sv{}
