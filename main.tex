...
\begin{document}
	...
	% ---  \cvachievement{\faTrophy}{Fantastic Achievement}{and some details about it}\\
		...
		challenges as well as being out in nature. At the moment I'm studying my fourth consecutive year at Chalmers University of Technology, and currently on my first year of my masters
        ...
        \cvsection{\en{Experience}\sv{Erfarenhet}}
            ...
            \en{
               	 At McDonald's I worked mainly in the kitchen and did all the tasks that came with the position, such as making sure there are thawed ingredients, all machines are clean and
		 operational and cooking the food. I'm also educated in all the service areas and manned the register, picked orders and took care of the drive-through. I have a finished education
		 as production manager which means I'm qualified to educate new personnel, as well as a partial education as shift manager. \\
            }
            \sv{
		...
		\cvevent{\en{Customer Service Agent}\sv{Kundserviceagent}}{| \en{Volvo Car Retail (Consultant - Manpower)}\sv{Volvo Car Retail (Konsult - Manpower)}}
			{\sv{Maj 2022 -- September 2022}\en{May 2022 -- September 2022}}{\en{Gothenburg, Sweden}\sv{Göteborg, Sverige}}
             \en{
                	Here I was employed by Volvo Car Retail as a consultant from Manpower. I worked at the facility Volvo Car Sörred in the Torslanda area. In the facility we had both retail of new
		and used cars as well as a workshop and car rental. My tasks a a customer service agent involved a very broad work area with a lot of problem solving and customer service. I 
		manned the "reception" to the facility and was the first point of contact for anyone entering for any purpose. From there it was my responsibility to make sure the customer gets 
		the help they need or sees the right person. A usual day could include things such as, ordering extra parts, making a workshop reservation, receiving and giving out rental cars as
		well as arranging test drives of both new and used cars. \\
            }
            \sv{
	 ...
	 \divider
		...
		\cvevent{\en{Gothenburg Representative}\sv{Göteborg Representant}}{| \en{Wanda Sweden}\sv{Wanda Sweden}}
			{\sv{Oktober 2022 --  }\en{October 2022 --  }}{\en{Gothenburg, Sweden}\sv{Göteborg, Sverige}}
            \en{
               	Wanda opened their first warehouse in Gothenburg in October of 2022 and I was the first on-site employee. I have since had the main responsibility for our operations here in 
		Gothenburg as the rest the personnel - including my nearest boss - is based in Stockholm. My responsibilities aside from the regular work has been educating new employees as well
	 	as making sure everything around the warehouse and our services works and keeping my closest boss updated. Since August of 2023 I have also had the responsibility of route
		planning/capacity management for all of our warehouses in Sweden. \\
            }
            \sv{
